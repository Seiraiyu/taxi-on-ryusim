...
rtl_dir = os.path.join(_taxi_root, 'src', 'cndm', 'board', 'DNPCIe_40G_KU_LL_2QSFP', 'fpga', 'rtl')
lib_dir = os.path.join(_taxi_root, 'src', 'cndm', 'board', 'DNPCIe_40G_KU_LL_2QSFP', 'fpga', 'lib')
